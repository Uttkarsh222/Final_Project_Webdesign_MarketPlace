        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+1 1234567891</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>shop@market.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>Boston, USA</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2024 Market Place Ltd. |</li>
